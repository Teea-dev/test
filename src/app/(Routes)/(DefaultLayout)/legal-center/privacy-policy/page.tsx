...
const title = 'Legal Center | Privacy Policy';
const description = `Read up on StarzFi Privacy Policy`;

export const metadata: Metadata = getPageDefaultMetadata(title, description, '/legal-center/privacy-policy');