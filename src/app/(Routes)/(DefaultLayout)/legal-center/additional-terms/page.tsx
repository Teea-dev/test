...
const title = 'Legal Center | Additional Terms';
const description = `Read up on StarzFi Additional terms and condition`;

export const metadata: Metadata = getPageDefaultMetadata(title, description, '/legal-center/additional-terms');